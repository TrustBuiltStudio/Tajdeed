  ...
  const services = [
    {
      ...
      description:
        'Comprehensive documentation including visa applications, translations, and official processing.',
      image:
    ...
    },
    {
      ...
      description:
        'Complete company formation, trade licenses, PRO services, and compliance advisory.',
      image:
    ...
    },
    {
      ...
      description:
        'Air ticket booking for domestic and international flights with best price guarantee.',
      image:
        'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    },
    {
      id: 4,
      ...
      image:
        'https://images.unsplash.com/photo-1562322140-8baeececf3df?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    },
  ];
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                <img
                  src={service.image}
                  alt={`${service.title} – one of our professional services at Takhlees Career Academy`}
