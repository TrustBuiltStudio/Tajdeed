          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Read More Button */}
                <button className="w-full py-2.5 text-center border-2 border-emerald-600 text-emerald-600 font-semibold rounded-lg hover:bg-emerald-600 hover:text-white transition-all duration-300">
                  Read More
                </button>
              </div>
            </div>
