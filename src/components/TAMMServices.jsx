...
const TAMMServices = () => {
  ...
  const tammServices = [
    ...
    "Owner Change",
    "Tenancy Contract Issuance and Renewal",
    "Company Fine Payment",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <img src={tj} alt="TAMM Services logo" className="h-24 w-auto" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: "#1a1a1a" }}>
            TAMM <span style={{ color: "#059669" }}>Services</span>
          </h1>
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: "#4B5563", fontWeight: "500" }}>
            Streamlined services for business and personal documentation through TAMM.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-emerald-100">
            <div className="p-8">
              <h2 className="text-2xl font-bold mb-6 text-emerald-800">Our TAMM Services Include:</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {tammServices.map((service, index) => (
          ...
          <div className="mt-12 text-center">
            <button
              onClick={() => openWhatsApp("TAMM Services")}
              ...
              aria-label="Enquire about TAMM Services via WhatsApp"
            >
              <span>📞</span>
              Enquire Now
            </button>
            <p className="mt-4 text-sm text-gray-500">
              Fast, reliable TAMM service support – contact us today.
            </p>
          </div>
        </div>
      </div>
